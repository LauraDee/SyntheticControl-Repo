...
dat2 <- scdata(df = dat, id.var = "City", time.var = "year", outcome.var = "n.obs45km", period.pre = (2015:2021), period.post = (2022:2023), unit.tr = "Philadelphia", unit.co = setdiff(unique(city.data$City), "Philadelphia"), constant = TRUE, cointegrated.data = TRUE, features = NULL, cov.adj = NULL)
